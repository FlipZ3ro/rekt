...
***************************************************************************** */
    ...
    46160: function(t, e, n) {
        ...
        class i extends o.IJsonRpcProvider {
            ...
            async request(t, e) {
                ...
                o.formatJsonRpcRequest)(t.method, t.params || [], (0,
    ...
    62873: function(t, e) {
        ...
        function n(t) {
            let e;
            return "undefined" != typeof window && void 0 !== window[t] && (e = window[t]),
            e
        }
        function r(t) {
            let e = n(t);
            if (!e)
                throw Error(`${t} is not defined in Window`);
            return e
        }
        Object.defineProperty(e, "__esModule", {
            value: !0
    ...
    65755: function(t, e, n) {
        ...
        e.D = function() {
            ...
            let i = ((n = o("name", "og:site_name", "og:title", "twitter:title")) || (n = t.title),
            n)
              , s = function() {
    ...
    44020: function(t) {
        ...
        t.exports = function(t) {
            if ("string" != typeof t)
                throw TypeError("Expected `encodedURI` to be of type `string`, got `" + typeof t + "`");
            try {
    ...
    43631: function(t, e, n) {
        ...
        function h(t) {
            ...
            var a = s.join(".")
              ...
              , h = f.exec(t);
            return h && h[1] ? new c(n,a,d,h[1]) : new i(n,a,d)
        }
    },
    17187: function(t) {
        "use strict";
        ...
        i.prototype.emit = function(t) {
            ...
            if ("function" == typeof u)
                ...
                for (var a = u.length, f = h(u, a), n = 0; n < a; ++n)
                    r(f[n], this, e);
            return !0
        }
        ,
